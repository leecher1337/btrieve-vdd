;****************************************************************
;* BTRIEVE DOS DEVICE DRIVER FOR DOSEMU2                        *
;*                                                              *
;* leecher@dose.0wnz.at                                 03/2020 *
;****************************************************************
...
init     proc near               ;Init-routine
         ...
         mov  cx, 1h             ;Function code for reigster driver
         int  0e6h               ;Register with dosemu2
         int  21h                ;Register interrupt vector
         jmp  finish_init        ;No more space here, continue down there
...
;-- Remaining init code that doesn't fit above -------------------------
